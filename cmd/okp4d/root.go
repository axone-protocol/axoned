...
func (ac appCreator) newApp(
	...
	return app.NewOKP4App(logger, db, traceStore, true, skipUpgradeHeights,
...
func (ac appCreator) appExport(
	...
	return okp4App.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
