...
func (app *App) setupUpgradeHandlers() {
	...
	app.UpgradeKeeper.SetUpgradeHandler(
		v41.UpgradeName,
		v41.CreateUpgradeHandler(app.ModuleManager, app.configurator),
	)

	app.UpgradeKeeper.SetUpgradeHandler(
		v5.UpgradeName,
		v5.CreateUpgradeHandler(app.ParamsKeeper, &app.ConsensusParamsKeeper, app.ModuleManager, app.configurator),
	)
