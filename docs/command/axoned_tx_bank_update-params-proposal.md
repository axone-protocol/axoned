## axoned tx bank update-params-proposal

Submit a proposal to update bank module params. Note: the entire params must be provided.

```
axoned tx bank update-params-proposal [params] [flags]
```

### Examples

```
axoned tx bank update-params-proposal '{ "default_send_enabled": true }'
```
