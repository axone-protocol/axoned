## axoned tx circuit disable

Disable a message from being executed

```
axoned tx circuit disable [msg_type_urls] [flags]
```

### Examples

```
axoned circuit disable "cosmos.bank.v1beta1.MsgSend cosmos.bank.v1beta1.MsgMultiSend"
```
