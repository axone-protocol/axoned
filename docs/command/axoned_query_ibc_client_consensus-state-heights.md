## axoned query ibc client consensus-state-heights
...
```
axoned query ibc client consensus-state-heights [client-id] [flags]
```

### Examples

```
axoned query ibc client consensus-state-heights [client-id]
```
