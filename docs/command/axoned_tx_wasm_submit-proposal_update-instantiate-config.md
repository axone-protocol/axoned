## axoned tx wasm submit-proposal update-instantiate-config
...
Example:
$ axoned tx gov submit-proposal update-instantiate-config 1:nobody 2:everybody 3:axone1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm,axone1vx8knpllrj7n963p9ttd80w47kpacrhuts497x

```
axoned tx wasm submit-proposal update-instantiate-config [code-id:permission] --title [text] --summary [text] --authority [address] [flags]
```
