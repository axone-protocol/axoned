...
Example:
$ axoned tx staking redelegate cosmosvalopers1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj cosmosvalopers1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100stake --from mykey

```
axoned tx staking redelegate [src-validator-addr] [dst-validator-addr] [amount] [flags]
```
