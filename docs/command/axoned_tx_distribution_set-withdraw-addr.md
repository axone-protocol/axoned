## axoned tx distribution set-withdraw-addr
...
Example:
$ axoned tx distribution set-withdraw-addr axone1gghjut3ccd8ay0zduzj64hwre2fxs9ld75ru9p --from mykey

```
axoned tx distribution set-withdraw-addr [withdraw-addr] [flags]
```
