## axoned query ibc-fee total-ack-fees
...
```
axoned query ibc-fee total-ack-fees [port-id] [channel-id] [sequence] [flags]
```

### Examples

```
axoned query ibc-fee total-ack-fees transfer channel-5 100
```
