## axoned tx ibc client recover-client

recover an IBC client
...
```
axoned tx ibc client recover-client [subject-client-id] [substitute-client-id] [flags]
```
...
```
  ...
  -h, --help                     help for recover-client
