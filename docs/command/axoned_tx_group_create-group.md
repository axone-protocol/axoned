...
```
axoned tx group create-group [admin] [metadata] [members-json-file] [flags]
```
...
axoned tx group create-group [admin] [metadata] [members-json-file]
