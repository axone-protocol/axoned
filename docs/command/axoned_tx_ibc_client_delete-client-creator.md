## axoned tx ibc client delete-client-creator

delete the client creator

```
axoned tx ibc client delete-client-creator [client-id] [flags]
```

### Examples

```
axoned tx ibc client delete-client-creator 07-tendermint-0
```
...
```
  ...
  -h, --help                        help for delete-client-creator
