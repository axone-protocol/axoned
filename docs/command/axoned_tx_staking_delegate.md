...
Example:
$ axoned tx staking delegate cosmosvalopers1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000stake --from mykey

```
axoned tx staking delegate [validator-addr] [amount] [flags]
```
