## axoned tx distribution community-pool-spend-proposal

Submit a proposal to spend from the community pool

```
axoned tx distribution community-pool-spend-proposal [recipient] [amount] [flags]
```

### Examples

```
$ axoned tx distribution community-pool-spend-proposal [recipient] 100uatom
```
