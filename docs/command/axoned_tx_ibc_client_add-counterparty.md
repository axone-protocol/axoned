## axoned tx ibc client add-counterparty

add counterparty to client

```
axoned tx ibc client add-counterparty [client-id] [counterparty-client-id] [merkle-prefix...] [flags]
```

### Examples

```
axoned tx ibc client add-counterparty 07-tendermint-0 client-0 "aWJj" ""
```
...
```
  ...
  -h, --help                        help for add-counterparty
