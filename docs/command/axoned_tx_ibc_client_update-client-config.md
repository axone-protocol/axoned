## axoned tx ibc client update-client-config

update allowed relayers for a client (replaces existing list, and no addresses means empty list and permissionless relaying)

```
axoned tx ibc client update-client-config client-id [allowed-relayer-addresses...] [flags]
```

### Examples

```
axoned tx ibc client update-client-params 08-wasm-0 cosmos123... cosmos456...
```
...
```
  ...
  -h, --help                        help for update-client-config
