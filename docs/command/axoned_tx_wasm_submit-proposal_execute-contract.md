## axoned tx wasm submit-proposal execute-contract

Submit a execute wasm contract proposal (run by any address)

```
axoned tx wasm submit-proposal execute-contract [contract_addr_bech32] [json_encoded_execution_args] --title [text] --summary [text] --authority [address] [flags]
```
