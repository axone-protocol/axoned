## axoned tx slashing update-params-proposal
...
Submit a proposal to update slashing module params. Note: the entire params must be provided.
 See the fields to fill in by running `axoned query slashing params --output json`

```
axoned tx slashing update-params-proposal [params] [flags]
```

### Examples

```
axoned tx slashing update-params-proposal '{ "signed_blocks_window": "100", ... }'
```
