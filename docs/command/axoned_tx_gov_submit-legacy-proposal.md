## axoned tx gov submit-legacy-proposal
...
$ axoned tx gov submit-legacy-proposal --title="Test Proposal" --description="My awesome proposal" --type="Text" --deposit="10test" --from mykey

```
axoned tx gov submit-legacy-proposal [flags]
```
