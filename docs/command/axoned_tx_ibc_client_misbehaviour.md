## axoned tx ibc client misbehaviour
...
```
axoned tx ibc client misbehaviour [clientID] [path/to/misbehaviour.json] [flags]
```

### Examples

```
axoned tx ibc client misbehaviour [clientID] [path/to/misbehaviour.json] --from node0 --home ../node0/<app>cli --chain-id $CID
```
