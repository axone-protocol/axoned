...
find the proposal-id by running "axoned query gov proposals".

Example:
$ axoned tx gov weighted-vote 1 yes=0.6,no=0.3,abstain=0.05,no_with_veto=0.05 --from mykey

```
axoned tx gov weighted-vote [proposal-id] [weighted-options] [flags]
```
