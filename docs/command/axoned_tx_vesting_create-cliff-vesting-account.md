## axoned tx vesting create-cliff-vesting-account

Create a new vesting account funded with an allocation of tokens with cliff.
...
```
axoned tx vesting create-cliff-vesting-account [to_address] [amount] [cliff_time] [end_time] [flags]
```
