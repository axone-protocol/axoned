...
import (
	...
	vestingtestutil "github.com/axone-protocol/axoned/v10/x/vesting/testutil"
...
func (s *VestingTestSuite) TestCreateCliffVestingAccount() {
	testCases := map[string]struct {
		preRun    func()
		input     *vestingtypes.MsgCreateCliffVestingAccount
		expErr    bool
		expErrMsg string
	}{
		"empty from address": {
